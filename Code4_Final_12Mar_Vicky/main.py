...
def main():
    ...
    # Get Slurm Task ID from environment 
    # This identifies which of the 50 tasks (0-49) this is
    ...
    # Pass a unique name to the directory creator 
    # include both the Task ID and the Seed in the folder name
    run_name = f"MIL_Task2_ID{task_id}_Seed{args.seed}"
    run_dir = create_run_directory(name=run_name)
