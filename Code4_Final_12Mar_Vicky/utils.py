...
def create_run_directory(name: str = None, base_dir: str = None) -> str:
    """Create a unique run directory with timestamp and a unique name"""
    ...
    # Use the 'name' passed from main.py, or fall back to SLURM_JOB_NAME
    if name is None:
        name = os.environ.get('SLURM_JOB_NAME', 'run')
    # This creates (eg): runs/20260312_1600_MIL_Task2_ID0_Seed10
    run_dir = os.path.join(base_dir, f"{timestamp}_{name}")
