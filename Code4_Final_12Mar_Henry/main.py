...
def main():
    ...
    if not args.eval_only:
        ...
        train_results = {'best_val_loss': 0.0, 'epochs': 0}
    ...
    results_content = f"""\
    Training Results: 
    Best Val Loss: {round(train_results['best_val_loss'], 4) if not args.eval_only else 'N/A'}
    Epochs: {train_results['epochs'] if not args.eval_only else 'N/A'}
    ...
    with open(results_path, 'w') as f:
        f.write(textwrap.dedent(results_content))
